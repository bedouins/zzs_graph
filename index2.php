...
<html lang="en">
	...
	<body><form action="index2.php" method="post">
	  <label for="node_th">企业规模</label>
	  <input type="text" name="node_th" id="node_th">
      <label for="link_th">往来规模</label>
      <input type="text" name="link_th" id="link_th">
	</form>
