...
d3.json("testoraclejson_nodes.php?node_th=10000000&link_th=1000000<?php  print "&nsrlist='".$_REQUEST['nsrsbh']."'";?>", function(error, graph) {
  force
      .nodes(graph.nodes)
      .links(graph.links)
      .start();
    ...
    .enter().append("g")
      .attr("class", "node")
       .on("click", function(d) {
  			...
  			window.open("fpcgl_single.php?nsrsbh="+d.nsrsbh,"_self");})
        .call(force.drag);
